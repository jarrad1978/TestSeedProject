...
public class TestSeedProjectDatabaseCheck : IHealthCheck, ITransientDependency
{
    protected readonly IIdentityRoleRepository IdentityRoleRepository;

    public TestSeedProjectDatabaseCheck(IIdentityRoleRepository identityRoleRepository)
    {
