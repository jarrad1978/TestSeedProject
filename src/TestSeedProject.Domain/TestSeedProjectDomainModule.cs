...
[DependsOn(
    typeof(TestSeedProjectDomainSharedModule),
...
public class TestSeedProjectDomainModule : AbpModule
{
        ...
        Configure<NewsletterOptions>(options =>
        {
            options.AddPreference(
                ...
                new NewsletterPreferenceDefinition(
                    LocalizableString.Create<TestSeedProjectResource>("NewsletterPreference_Default"),
                    privacyPolicyConfirmation: LocalizableString.Create<TestSeedProjectResource>("NewsletterPrivacyAcceptMessage")
                )
            );
        });
