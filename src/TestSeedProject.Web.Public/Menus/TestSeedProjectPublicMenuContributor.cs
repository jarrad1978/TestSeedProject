...
namespace TestSeedProject.Web.Public.Menus;

public class TestSeedProjectPublicMenuContributor : IMenuContributor
{
    private readonly IConfiguration _configuration;

    public TestSeedProjectPublicMenuContributor(IConfiguration configuration)
    {
    ...
    private Task ConfigureMainMenuAsync(MenuConfigurationContext context)
    {
        ...
        context.Menu.AddItem(
            new ApplicationMenuItem(
                TestSeedProjectPublicMenus.HomePage,
                l["Menu:Home"],
                "~/",
                icon: "fa fa-home",
                order: 1
        ...
        context.Menu.AddItem(
            new ApplicationMenuItem(
                TestSeedProjectPublicMenus.ArticleSample,
        ...
        context.Menu.AddItem(
            new ApplicationMenuItem(
                TestSeedProjectPublicMenus.ContactUs,
                l["Menu:ContactUs"],
                "~/contact-us",
                icon: "fa fa-phone",
                order: 3
