...
````bash
Add-Migration Your_Migration_Name -Context TestSeedProjectDbContext
````

Using EF Core command line tool;

````bash
dotnet ef migrations add Your_Migration_Name --context TestSeedProjectDbContext
````
...
````bash
Add-Migration Your_Migration_Name -Context TestSeedProjectTenantDbContext -OutputDir TenantMigrations
````

Using EF Core command line tool:

````bash
dotnet ef migrations add Your_Migration_Name --context TestSeedProjectTenantDbContext --output-dir TenantMigrations
````
