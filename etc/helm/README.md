...
```
127.0.0.1 testseedproject-local-web
127.0.0.1 testseedproject-local-webgateway
127.0.0.1 testseedproject-local-authserver
```
...
Now, you can browse the URL: `https://testseedproject-local-web`
